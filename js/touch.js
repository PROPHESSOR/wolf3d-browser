        ...
        if (!keys) {
			...
			$('#mvup')//38
                .on("touchstart", function(e) {
                    ...
                    keys[38] = true;
                    if (bindings[38]) {
                        for (var i=0,n=bindings[38].length;i<n;i++) {
                            bindings[38][i](e);
                        }
                    }
                })
			...
			$('#mvdown')//40
                .on("touchstart", function(e) {
                    ...
                    keys[40] = true;
                    if (bindings[40]) {
                        for (var i=0,n=bindings[40].length;i<n;i++) {
                            bindings[40][i](e);
                        }
                    }
                })
			...
			$('#mvleft')//37
                .on("touchstart", function(e) {
                    ...
                    keys[37] = true;
                    if (bindings[37]) {
                        for (var i=0,n=bindings[37].length;i<n;i++) {
                            bindings[37][i](e);
                        }
                    }
                })
			...
			$('#mvright')//39
                .on("touchstart", function(e) {
                    ...
                    keys[39] = true;
                    if (bindings[39]) {
                        for (var i=0,n=bindings[39].length;i<n;i++) {
                            bindings[39][i](e);
                        }
                    }
                })
                ...
                .on("touchstart", function(e) {
                    ...
                    keys[88] = true;
                    if (bindings[88]) {
                        for (var i=0,n=bindings[88].length;i<n;i++) {
                            bindings[88][i](e);
                        }
                    }
                })
			...
			$('#mvspace')//32
                .on("touchstart", function(e) {
                    ...
                    keys[32] = true;
                    if (bindings[32]) {
                        for (var i=0,n=bindings[32].length;i<n;i++) {
                            bindings[32][i](e);
                        }
                    }
                })
